    ...
    <div class="d-flex align-items-stretch">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled">
                <li class="active"><a href="{{ route('admin.home.page') }}"> <i class="icon-home"></i>Home </a></li>
                <li><a href="{{ route('admin.category.page') }}"> <i class="icon-grid"></i>Category</a></li>
                ...
                <li><a href="{{ route('borrow.book.request') }}"> <i class="icon-logout"></i>Borrow Request</a></li>
            ...
            <footer class="footer">
                <div class="footer__block block no-margin-bottom">
                    <div class="container-fluid text-center">
                        ...
                        <p class="no-margin-bottom">2025 &copy; MD TOMAS UDDIN <a target="_blank">
                                mdtomasuddin1@gmail.com</a>.</p>
                    </div>
                </div>
            </footer>
        </div>
